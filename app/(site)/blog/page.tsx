      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post) => (
              <Link
                ...
                className="group"
              >
                <div className="bg-white text-black p-8 h-full flex flex-col transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h2 className="text-xl font-semibold tracking-tight mb-2 group-hover:underline decoration-2 underline-offset-4 line-clamp-2">
                        {post.title}
                      </h2>
                    </div>
                    <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-black transition-colors flex-shrink-0 ml-2 mt-1" />
                  </div>

                  {/* Description */}
                  {post.description && (
                    <p className="text-sm text-gray-600 leading-relaxed mb-6 flex-grow font-light line-clamp-3">
                      {post.description}
                    </p>
                  )}
        ...
        <div className="mt-32 text-center">
          ...
          <p className="text-gray-500 text-base font-light mb-8 max-w-xl mx-auto">
            Want to read more? Check out my Medium profile for additional articles, tutorials, and technical deep dives.
          </p>
          <a

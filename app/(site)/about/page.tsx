      ...
      <section className="min-h-screen px-6 py-32">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-24">
            ...
            <h2 className="text-6xl md:text-8xl font-bold tracking-tight leading-none mb-8">
          ...
          <div className="space-y-32">
            ...
            {/* Tech Stack */}
            <div>
              <h3 className="text-[10px] tracking-[0.4em] uppercase text-gray-600 font-medium mb-12">Technology Stack</h3>
              ...
              <div className="space-y-16">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-900">
                    ...
                    <div className="text-xs tracking-[0.2em] uppercase text-gray-600 font-medium">Languages</div>
                  </div>
                  <div className="flex flex-wrap gap-3">
                    {techStack.languages.map((tech, idx) => (
                      <div
                        key={idx}
                        className="group px-5 py-2.5 bg-white text-black text-sm font-medium hover:bg-gray-100 transition-all duration-300 cursor-pointer"
                ...
                <div>
                  <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-900">
                    ...
                    <div className="text-xs tracking-[0.2em] uppercase text-gray-600 font-medium">Frameworks</div>
                  </div>
                  <div className="flex flex-wrap gap-3">
                    {techStack.frameworks.map((tech, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          <span className="text-base font-medium">{tech.icon}</span>
                          <span>{tech.name}</span>
                        </div>
                      </div>
                    ))}
                ...
                <div>
                  <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-900">
                    ...
                    <div className="text-xs tracking-[0.2em] uppercase text-gray-600 font-medium">Databases</div>
                  </div>
                  <div className="flex flex-wrap gap-3">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-900">
                    ...
                    <div className="text-xs tracking-[0.2em] uppercase text-gray-600 font-medium">Infrastructure</div>
                  </div>
                  <div className="flex flex-wrap gap-3">
            ...
            {/* Core Focus */}
            <div>
              <h3 className="text-[10px] tracking-[0.4em] uppercase text-gray-600 font-medium mb-12">Core Focus</h3>
